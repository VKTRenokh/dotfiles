...
autocmd("Filetype", {pattern = "*", group = vim.api.nvim_create_augroup("SexpInsert", {clear = true}), callback = _4_})
local function _7_()
...
return tx("guns/vim-sexp", {dependencies = {"tpope/vim-sexp-mappings-for-regular-people", "tpope/vim-repeat", "tpope/vim-surround"}, event = "VeryLazy", init = _7_})
